 ...
 * and routes into an Inn/Church/Store/Tavern/Stash sub-view; Esc from a
 * sub-view returns to the overview. From the overview, leaving town
 * dispatches a scene change to the overworld (PROJECT_PLAN Phase 2, ROG-8).
 */
