...
- The village Stash gives unlimited storage for generated gear, separate from the field backpack's tunable cap (`FIELD_BACKPACK_CAP`, 20 slots); consumables, currency, and quest items never count against the cap. A full backpack forces a swap-or-dismantle triage prompt on the next gear drop instead of silently losing it. <source: src/engine/loot/inventory.ts, src/engine/loot/pickup.ts, and src/ui/screens/village/StashView.tsx, 2026-07-25>
